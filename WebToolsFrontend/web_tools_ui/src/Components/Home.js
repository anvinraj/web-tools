            ...
            <div className="body">
                { this.state.loading ?
                    <div className="loaderContainer">
                        <ClipLoader color="ffffff" loading={this.state.loading} css={override}  size={50} />
                    </div>
                : null
                }
